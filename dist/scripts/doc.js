...
var STK_COUNTER_STYLE_CONFIG = {
  ...
  textFillStyle: '#fdeada',
  triangleFillStyle: '#fdeada',
  outerRimStrokeStyle: '#fdeada',
  staticOuterRimStrokeStyle: '#fdeada',
  innerRimStrokeStyle: '#fdeada',
  layerFillStyle: 'rgba(0, 0, 0, 0)',
  staticLayerFillStyle: 'rgba(0, 0, 0, 0)',
}
    ...
    var that = {
        ...
        */
        displayClick: function() {
            ...
            pxTag.src = "https://app.trackly.eu/rmtag/82213/" + tstmp;

            console.log("Pixel remarketing" + " link " + pxTag.src);


            //pixel klienta
            let client = 'https://ad.doubleclick.net/ddm/trackimp/N9439.1874361SATAKU.COM/B25877865.303207326;dc_trk_aid=496249839;dc_trk_cid=150926076;ord=[timestamp];dc_lat=;dc_rdid=;tag_for_child_directed_treatment=;tfua=;gdpr=${GDPR};gdpr_consent=${GDPR_CONSENT_755};ltd=?' + tstmp;

            _that.pixel(client);

            console.log("PIXEL KLIENTA" + " link " + client);
        ...
        var _that = {
            ...
            setContext: function(param, context) {
                ...
                param.stkExt({
                    ...
                    fillStyle: param.fillStyle || '#fdeada',
                    textAlign: param.textAlign || 'center',
                    strokeStyle: param.strokeStyle || '#fdeada',
